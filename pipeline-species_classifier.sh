...
# nacti 1200
python main.py --config config.species_classifier.nacti.aip_resnet50_1200 --mode train
python main.py --config config.species_classifier.nacti.improved_aip_resnet50_1200 --mode train
python main.py --config config.species_classifier.nacti.resnet50_1200 --mode train

python main.py --config config.species_classifier.nacti.aip_resnet50_1200 --mode test
python main.py --config config.species_classifier.nacti.improved_aip_resnet50_1200 --mode test
python main.py --config config.species_classifier.nacti.resnet50_1200 --mode test

# nacti 2400
python main.py --config config.species_classifier.nacti.aip_resnet50_2400 --mode train
python main.py --config config.species_classifier.nacti.improved_aip_resnet50_2400 --mode train
python main.py --config config.species_classifier.nacti.resnet50_2400 --mode train

python main.py --config config.species_classifier.nacti.aip_resnet50_2400 --mode test
python main.py --config config.species_classifier.nacti.improved_aip_resnet50_2400 --mode test
python main.py --config config.species_classifier.nacti.resnet50_2400 --mode test

# nacti 4800
python main.py --config config.species_classifier.nacti.aip_resnet50_4800 --mode train
python main.py --config config.species_classifier.nacti.improved_aip_resnet50_4800 --mode train
python main.py --config config.species_classifier.nacti.resnet50_4800 --mode train

python main.py --config config.species_classifier.nacti.aip_resnet50_4800 --mode test
python main.py --config config.species_classifier.nacti.improved_aip_resnet50_4800 --mode test
python main.py --config config.species_classifier.nacti.resnet50_4800 --mode test

# # nacti 9600
# python main.py --config config.species_classifier.nacti.aip_resnet50_9600 --mode train
# python main.py --config config.species_classifier.nacti.improved_aip_resnet50_9600 --mode train
# python main.py --config config.species_classifier.nacti.resnet50_9600 --mode train

# python main.py --config config.species_classifier.nacti.aip_resnet50_9600 --mode test
# python main.py --config config.species_classifier.nacti.improved_aip_resnet50_9600 --mode test
# python main.py --config config.species_classifier.nacti.resnet50_9600 --mode test
